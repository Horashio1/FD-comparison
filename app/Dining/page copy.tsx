...
const diningPlaces: DiningPlace[] = [
  {
    ...
    thumbsUp: 124,
    thumbsDown: 12,
    tags: ["Fine Dining", "Seafood", "Open Late", "Reservation Required", "Private Area"]
  },
  {
    id: 2,
    name: "Graze Kitchen",
    ...
    thumbsUp: 89,
    thumbsDown: 15,
    tags: ["Buffet", "International", "Child Friendly", "Large Groups", "Private Area"]
  },
  {
    id: 3,
    name: "Nuga Gama",
    ...
    thumbsUp: 156,
    thumbsDown: 8,
    tags: ["Sri Lankan", "Buffet", "BYOB", "Outdoor Seating", "Large Groups"]
  }
];
...
const tagColors: Record<string, string> = {
  ...
  "Child Friendly": "bg-green-100 text-green-800 border-green-200",
  ...
  "Outdoor Seating": "bg-teal-100 text-teal-800 border-teal-200",
  "Private Area": "bg-red-100 text-red-800 border-red-200",
  "Reservation Required": "bg-gray-100 text-gray-800 border-gray-200",
  "Seafood": "bg-cyan-100 text-cyan-800 border-cyan-200",
  "Sri Lankan": "bg-emerald-100 text-emerald-800 border-emerald-200"
};
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 py-6 md:px-8">
        <div className="space-y-4 mb-8">
          <h1 className="text-3xl font-bold text-gray-900">Colombo Dining Guide</h1>
          <div className="flex flex-col sm:flex-row sm:items-center gap-4">
            ...
            <button
              ...
              className="sm:hidden flex items-center gap-2 px-4 py-2 bg-white rounded-lg border"
            >
          ...
          <div className="sm:hidden fixed inset-0 bg-gray-900 bg-opacity-50 z-50">
            <div className="bg-white rounded-t-xl p-6 fixed bottom-0 left-0 right-0 max-h-[60vh] overflow-y-auto">
              <div className="flex justify-between items-center mb-4">
                ...
                <span className="text-sm text-gray-500">{selectedTags.length} selected</span>
              </div>
