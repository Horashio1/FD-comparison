...
const services = [
  {
    ...
    href: "/Card_Offers",
    gradient:
      "from-blue-100 via-blue-50 to-indigo-50 dark:from-blue-900/20 dark:via-blue-800/20 dark:to-indigo-900/20",
  ...
  },
  {
    ...
    href: "/FD_Rates",
    gradient:
      "from-emerald-100 via-emerald-50 to-teal-50 dark:from-emerald-900/20 dark:via-emerald-800/20 dark:to-teal-900/20",
  ...
  },
  {
    ...
    href: "/Tourist_Data",
    gradient:
      "from-purple-100 via-purple-50 to-pink-50 dark:from-purple-900/20 dark:via-purple-800/20 dark:to-pink-900/20",
    hoverGradient: "group-hover:from-purple-500 group-hover:to-pink-500",
    description:
      "Find the best mobile data packages for tourists visiting Sri Lanka",
  },
];
...
export default function HomePage() {
  ...
  return (
    <section className="w-full flex flex-col items-center justify-center overflow-hidden">
      {/* Hero Section */}
      <section className="relative w-full py-8 md:py-24 lg:py-24 bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50 dark:from-blue-950/40 dark:via-purple-950/40 dark:to-pink-950/40">
        ...
        <div className="container relative mx-auto flex flex-col items-center px-4 md:px-6 text-center">
          <div className="space-y-4 animate-fade-in">
            ...
            <p className="mx-auto max-w-[700px] text-gray-600 md:text-xl dark:text-gray-300">
              Compare fixed deposits, tourist data plans, and card offers to
      ...
      {/* Services Section */}
      <section className="w-full py-8 md:py-16 lg:py-16">
                ...
                >
                  <Card
                    className={`
                      ...
                      ${
                        animatingCard === index
                          ? service.hoverGradient.replace("group-hover:", "")
                          : ""
                      }
                    `}
                  >
                    <CardHeader className="relative">
                      <div
                        className={`mb-4 transition-transform duration-300 transform 
                      ...
                      >
                        <service.icon
                          className={`
                            h-16 w-16 text-gray-700 dark:text-gray-300 transition-colors duration-300
                      ...
                      <CardTitle
                        className={`
                          text-3xl font-bold transition-colors duration-300 text-gray-900 dark:text-gray-100
                          group-hover:text-white
                          ${animatingCard === index ? "text-white" : ""}
                        `}
                      >
